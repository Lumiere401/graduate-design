...
def predict_test():
    Vnet2d = Vnet2dModule(512, 768, channels=1, costname="dice coefficient", inference=True,
                          model_path="Model/vnet2d/Vnet2d.pd")
    test_set_csv = pd.read_csv("E:\graduation project\HC18-Automated-measurement-of-fetal-head-circumference-master\HC18Challege\dataset\\test_set_pixel_size.csv")
    src_test_set = "E:\\graduation project\\HC18-Automated-measurement-of-fetal-head-circumference-master\\HC18Challege\dataset\\test_set\\src\\"
    mask_test_set = "E:\\graduation project\\HC18-Automated-measurement-of-fetal-head-circumference-master\\HC18Challege\dataset\\test_set\\mask\\"
...
def predict_validation():
    ...
    path = "E:\\graduation project\\HC18-Automated-measurement-of-fetal-head-circumference-master\\HC18Challege\dataset\\test_set\\src\\"
